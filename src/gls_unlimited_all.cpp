...
struct gls_configuration : public abstract_configuration<EA> {
    ...
    void initialize(EA& ea) {
        ...
        resource_ptr_type resE = make_resource("resE", ea);
        resource_ptr_type resF = make_resource("resF", ea);
        resource_ptr_type resG = make_resource("resG", ea);
        resource_ptr_type resH = make_resource("resH", ea);
        resource_ptr_type resI = make_resource("resI", ea);
