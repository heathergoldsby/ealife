...
namespace ea {
    namespace analysis {
        ...
        template <typename EA>
        struct lod_gls_aging_res_over_time_last_step : public ea::analysis::unary_function<EA> {
            static const char* name() { return "lod_gls_aging_res_over_time_last_step"; }
            ...
            virtual void operator()(EA& ea) {
                ...
                datafile df("lod_gls_aging_res_over_time_last_step.dat");
                df.add_field("lod_depth")
                .add_field("update")
                .add_field("res");
